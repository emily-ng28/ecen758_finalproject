...
Our project compares the performance of a traditional Convolutional Neural Network (CNN) and a fine-tuned ResNet18 model on the STL-10 dataset.

### **Dataset**
- **STL-10** (train: 5,000 images, validation: 1,000 images, test: 8,000 images)
...
- CNN: learning rate = 1e-3, weight decay = 1e-3, epochs = 50
